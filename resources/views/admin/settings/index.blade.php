    ...
    @if($activeTab === 'smtp')
        <div class="card" style="max-width: 720px;">
            <div class="card-header">
                ...
                <p style="margin: 4px 0 0; font-size: 13px; color: var(--text2);">Used to send review invitation emails to clients. Settings are stored in the database.</p>
            </div>
        ...
        <div class="card" style="max-width: 720px; margin-top: 20px;">
            <div class="card-header">
                ...
                <p style="margin: 4px 0 0; font-size: 13px; color: var(--text2);">Verify your SMTP settings are working by sending a test email.</p>
            </div>
        ...
        @forelse($templates as $template)
            <div class="card" style="max-width: 720px; margin-bottom: 20px;">
                <div class="card-header">
                    ...
                    <p style="margin: 4px 0 0; font-size: 13px; color: var(--text2);">
                ...
                <form method="POST" action="{{ route('admin.settings.templates.update', $template) }}">
                    ...
                    <div class="form-group">
                        ...
                        <p style="font-size: 12px; color: var(--text2); margin: 0 0 6px;">The main message paragraph shown in the email. Leave blank to use the default copy.</p>
